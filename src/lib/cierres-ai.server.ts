...
- SIGNO: respeta escrupulosamente los importes negativos. Si el importe aparece con un signo menos delante del número o delante del símbolo de euro (por ejemplo "-€ 562,00", "-562,00", "€ -562,00"), entre paréntesis "(562,00)", o precedido de un guion, devuélvelo como número negativo (-562). No conviertas nunca un negativo en positivo ni al revés. El TOTAL de la hoja debe ser igual a la suma de BF+EF+BS+ES con sus signos: úsalo para comprobar tus signos antes de responder.
